...
public class RecycleWayBillManagementRightAdapter extends RecyclerView.Adapter<RecycleWayBillManagementRightAdapter.ViewHolder> {
    private List<String> mList;
    private Context mContext;
    private onChildListener onChildListener;
    //private ActLoginBannerAdapterBinding mBinding;

    public RecycleWayBillManagementRightAdapter(List<String> mList, Context mContext) {
        this.mList = mList;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View contentView = inflate.inflate(R.layout.act_waybill_nanagement_right_adapter, parent, false);
    ...
    public void setOnChildListener(RecycleWayBillManagementRightAdapter.onChildListener onChildListener) {
