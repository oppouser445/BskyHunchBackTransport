...
public class ApplyJoinTeamAdapter extends RecyclerView.Adapter<ApplyJoinTeamAdapter.ViewHolder> {
    private List<String> mList;
    private Context mContext;
    private onChildListener onChildListener;
    //private ActLoginBannerAdapterBinding mBinding;

    public ApplyJoinTeamAdapter(List<String> mList, Context mContext) {
        this.mList = mList;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View contentView = inflate.inflate(R.layout.item_apply_join_team_list, parent, false);
    ...
    public void setOnChildListener(ApplyJoinTeamAdapter.onChildListener onChildListener) {
