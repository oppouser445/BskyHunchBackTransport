...
public class CollectFreightAdapter extends RecyclerView.Adapter<CollectFreightAdapter.ViewHolder> {
    ...
    public CollectFreightAdapter(List<String> mList, Context mContext) {
        this.mList = mList;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View contentView = inflate.inflate(R.layout.item_collect_freight_list_layout, parent, false);
